...
const RSA: React.FC = () => {
  ...
  return (
    <div className='flex flex-col  justify-center items-center'>
      <header className='text-center font-bold text-5xl'>秘钥生成</header>
      <Divider />
      ...
      <header className=' font-bold text-5xl text-center mt-10'>加密解密</header>
      <Divider />
      ...
      <div >
        <div className='key_info flex flex-col justify-between'>
          <div className='flex flex-col md:flex-row  justify-center items-center  space-y-5 md:space-x-5 md:space-y-0'>
            ...
            <div className='other_public_key_container  flex-col'>
              <div>对方公钥</div>
              <textarea name="other_public_key" id="other_public_key" rows={10} placeholder='请填入对方的公钥'
        ...
        <div className=' text-3xl text-center'>加解密操作</div>
        <div className=' flex space-x-2 justify-center'>
          {/* 加密 */}
          <div className=' flex flex-col  space-y-3' >
            <textarea name="to_encrypted_msg" id="to_encrypted_msg" rows={7}
              cols={20} className=' text-slate-700' placeholder='输入你需要加密发给对方的内容'
              onChange={(event) => {
          ...
          <div className=' flex flex-col space-y-3'>
            <textarea name="encrypted_msg" id="encrypted_msg" rows={7}
              cols={20} className=' text-slate-700' placeholder='输入对方发来的待解密的内容'
              onChange={(event) => {
        ...
        <div className=' text-3xl text-center'>历史记录</div>
        {/* 历史记录 */}
